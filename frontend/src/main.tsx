...
createRoot(root!).render(
  <BrowserRouter future={{ v7_relativeSplatPath: true, v7_startTransition: true }}>
    ...
    <Routes>
      ...
      <Route path="/vendas/editar/:id" element={<PrivateRoute element={<VendasForm />} niveis={VENDEDOR} />} />
      ...
      <Route path="/produtos/novo" element={<PrivateRoute element={<ProdutoForm />} niveis={VENDEDOR} />} />
      <Route path="/produtos/editar/:id" element={<PrivateRoute element={<ProdutoForm />} niveis={VENDEDOR} />} />
      ...
      <Route path="/orcamentos/editar/:id" element={<PrivateRoute element={<OrcamentoForm />} niveis={TECNICO} />} />
      {/*FINANCEIRO*/}
